...
<div class="container" data-aos="zoom-in">
    <div class="row mt-5" id="interview">
        <div class="row">
            <div class="col-1"><h6>You:</h6></div>
            <div class="col-3"><h6>What is the big bang, and how did it start?</h6></div>
            <div class="col-5"></div>
        </div>
        <div class="row">
            <div class="col-1"><h6>Astronomer:</h6></div>
            <div class="col-6 ms-5"><p>The Big Bang is a theory that the universe began at a single point, infinitely hot and full of energy. Then, it exploded; suddenly expanding the universe at the speed of light. This lasted about 10^-32 seconds, and then cosmic inflation came to a standstill. The standstill meant that a flood of matter and radiation began populating the unviverse with the stuff we know about today: particles, atoms, and the building blocks for stars and galaxies. How it started? That is a question no scientist has a definite answer to.</p></div>
            <div class="col-2"></div>
        </div>
        <div class="row mt-3">
            <div class="col-1"><h6>You:</h6></div>
            <div class="col-3"><h6>What are stars made of?</h6></div>
            <div class="col-5"></div>
        </div>
        <div class="row">
            <div class="col-1"><h6>Astronomer:</h6></div>
            <div class="col-6 ms-5"><p>Stars are giant balls of hot gas, mostly hydrogen and helium.</p></div>
            <div class="col-2"></div>
        </div>
    </div>
</div>
